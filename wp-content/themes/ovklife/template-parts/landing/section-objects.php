 ...
 *
 * Галерея реализованных проектов со слайдером и карточками объектов.
 *
 * @package OVKLife
 * @since 1.0.0
 */
...
$projects = array(
	array(
		'title' => 'КП Охтинский парк (Энколово)',
		'type'  => 'Современный коттедж',
		'area'  => '220 м²',
		'works' => 'Электрика, отопление, автоматика, вентиляция, кондиционирование',
		'image' => 'tild3462-3733-4737-b365-363462636162__frame_48_2.jpg',
	),
	array(
		'title' => 'Подмосковье д. Трусово',
		'type'  => 'Загородная резиденция с бассейном',
		'area'  => '500 м²',
		'works' => 'Полный комплекс отопления, вентиляции, кондиционирование, электрика, автоматизация климата',
		'image' => 'tild6431-3765-4638-b730-373834636235__frame_50_1.jpg',
	),
	array(
		'title' => 'д. Васкелово',
		'type'  => 'Загородный бревенчатый дом',
		'area'  => '260 м²',
		'works' => 'Комплекс отопления, водоснабжения, канализации, кондиционирование, автоматизация климата',
	...
	array(
		...
		'type'  => 'Частный дом',
		'area'  => 'Реконструкция',
		'works' => 'Реконструкция отопления частного дома, электрика, автоматизация климата и света',
...
<section id="obekty" class="landing-section landing-section--light objects">
	<div class="landing-container">
		<div class="objects__header">
			<p class="objects__label"><?php esc_html_e( 'Наши объекты', 'ovklife' ); ?></p>
			<h2 class="objects__title"><?php esc_html_e( 'Какие дома нам доверили', 'ovklife' ); ?></h2>
		</div>
